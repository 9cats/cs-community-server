...
export class CS {
  static community: Record<CSCore.Community.Name, CSCore.Community> = {
    ...
    zed: new CSCore.Community("zed", "僵尸乐园").addServer([
      ...
      { name: "连跳[简单]", mode: "bhop", host: "cs3.zombieden.cn", port: 27050 },
      { name: "连跳[困难]", mode: "bhop", host: "cs3.zombieden.cn", port: 27051 },
      { name: "连跳[综合]", mode: "bhop", host: "cs3.zombieden.cn", port: 27052 },
      ...
      { name: "滑翔[简单]", mode: "surf", host: "cs6.zombieden.cn", port: 27201 },
      { name: "滑翔[困难]", mode: "surf", host: "cs6.zombieden.cn", port: 27202 },
      { name: "滑翔[综合]", mode: "surf", host: "cs6.zombieden.cn", port: 27203 },
      { name: "匪镇谍影1服", mode: "ttt", host: "cs6.zombieden.cn", port: 27055 },
      { name: "匪镇谍影2服", mode: "ttt", host: "cs6.zombieden.cn", port: 27056 },
      { name: "匪镇谍影3服", mode: "ttt", host: "cs6.zombieden.cn", port: 27057 },
    ]),
    ...
    for: new CSCore.Community("for", "外服").addServer([
      { name: "(俄)Net4ALL.RU", mode: "ze", host: "37.230.137.238", port: 27015 },
      { name: "(俄)CYBERSHOKE-1", mode: "ze", host: "37.230.210.75", port: 27024 },
      { name: "(俄)CYBERSHOKE-2", mode: "ze", host: "91.211.118.96", port: 27045 },
      { name: "(俄)THE LAST OF US", mode: "ze", host: "46.174.52.44", port: 27015 },
      { name: "(俄)BC18GO", mode: "ze", host: "46.174.53.198", port: 27015 },
      { name: "(俄)LEGIONWCSZM", mode: "ze", host: "146.19.87.169", port: 27015 },
      ...
      { name: "(法)MAPEADORES", mode: "ze", host: "87.98.228.196", port: 27040 },
      { name: "(阿根廷)Garryshost", mode: "ze", host: "45.235.98.233", port: 27015 },
    ...
    css: new CSCore.Community("css", "起源服").addServer([
      ...
      { name: "(美)UNLOZE-1", mode: "ze", host: "135.125.188.157", port: 27015 },
      { name: "(美)UNLOZE-2", mode: "ze", host: "135.125.188.157", port: 27035 },
    ]),
  };
}
